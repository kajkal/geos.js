// Generated by: cpp/scripts/process-geos-capi/index.mts
 ...
 *
 * Set the {@link GEOSMessageHandler} function for error and notice messages using
 * {@link initGEOS} or {@link initGEOS_r}.
 ...
 * The geometry type can be read with {@link GEOSGeomTypeId}. Most functions
 ...
 * Contains the list of vertices defining the location of a {@link GEOSGeometry}.
 ...
 */
export type GEOSCoverageCleanParams = 'GEOSCoverageCleanParams';
 ...
 */
export type GEOSClusterInfo = 'GEOSClusterInfo';
 ...
 * @returns 1 if calculation succeeded, 0 on failure
 */
export type GEOSTransformXYZCallback = (x: Ptr<f64>, y: Ptr<f64>, z: Ptr<f64>, userdata: Ptr<void>) => i32;
 ...
 */
export type GEOSContextInterruptCallback = (arg1: Ptr<void>) => i32;
 ...
 */
export declare enum GEOSOverlapMerge {
...
export declare enum GEOSRelateBoundaryNodeRules {
    ...
    /** Same as {@link GEOSRELATE_BNR_MOD2} */
...
export declare enum GEOSVoronoiFlags {
    ...
    /** Preserve order of inputs, such that the nth cell in the result corresponds to the nth vertex in the input. If this cannot be done, such as for inputs * that contain repeated points, {@link GEOSVoronoiDiagram} will return NULL. */
...
export interface WasmGEOS {
    ...
    /**
     * Free the memory associated with a {@link GEOSContextHandle_t}
     ...
     * @param extHandle - the context returned by {@link GEOS_init_r}.
     * @param cb - Callback function to invoke
     ...
     * @deprecated this function is not exported
     */
    GEOSContext_setInterruptCallback_r(extHandle: Ptr<GEOSContextHandle_t>, cb: Ptr<GEOSContextInterruptCallback>, userData: Ptr<void>): Ptr<GEOSContextInterruptCallback>;
     ...
     * @param extHandle - the GEOS context from {@link GEOS_init_r}
     ...
     * @deprecated this function is not exported
     */
    GEOSCoordSeq_createWithDimensions(size: u32, hasZ: i32, hasM: i32): Ptr<GEOSCoordSequence>;
     ...
     * @deprecated this function is not exported
     */
    GEOSCoordSeq_hasZ(s: Ptr<GEOSCoordSequence>): i8;
     ...
     * @deprecated this function is not exported
     */
    GEOSCoordSeq_hasM(s: Ptr<GEOSCoordSequence>): i8;
     ...
     * @deprecated this function is not exported
     */
    GEOSCoordSeq_setM(s: Ptr<GEOSCoordSequence>, idx: u32, val: f64): i32;
     ...
     * @deprecated this function is not exported
     */
    GEOSCoordSeq_getM(s: ConstPtr<GEOSCoordSequence>, idx: u32, val: Ptr<f64>): i32;
     ...
     * @returns A newly allocated point geometry. NULL on exception.
     ...
     * @returns A newly allocated empty point geometry. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
     ...
     * @param s - Input coordinate sequence, ownership passes to the geometry
     * @returns A newly allocated linear ring geometry. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
     ...
     * @param s - Input coordinate sequence, ownership passes to the geometry
     * @returns A newly allocated linestring geometry. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
     ...
     * @returns A newly allocated empty polygon geometry. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
     ...
     * @param s - Input coordinate sequence, ownership passes to the geometry
     * @returns A newly allocated CircularString geometry. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
     ...
     * Note: The geoms argument is an array of GEOSGeometry* objects.
     *       The caller **retains ownership** of the containing array,
     *       but the ownership of the pointed-to objects is transferred
     *       to the returned {@link GEOSGeometry}.
     * @param type - The geometry type, enumerated by {@link GEOSGeomTypes}
     * @param geoms - A list of geometries that will form the collection
     * @param ngeoms - The number of geometries in the geoms list
     * @returns A newly allocated geometry collection. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     */
     ...
     * @param type - The geometry type, enumerated by {@link GEOSGeomTypes}
     * @returns A newly allocated empty geometry collection. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
     ...
     * @returns A string with the geometry type.
     ...
     * @param g - Input geometry
     * @returns A void* to the user data, caller is responsible for
     ...
     * Note: Up to GEOS 3.2.0 the input geometry must be a Collection, in
     *       later versions it doesn't matter (getGeometryN(0) for a single will
     *       return the input).
     * @param g - Input geometry
     * @param n - Sub-geometry index, zero-based
     * @returns A const {@link GEOSGeometry}, do not free!
     ...
     * Note: Returned object is a pointer to internal storage:
     *       it must NOT be destroyed directly.
     * @param g - Input Polygon geometry
     ...
     * @returns 1 when simple, 0 when non-simple, 2 on exception
     * @deprecated this function is not exported
     */
    GEOSisSimpleDetail(g: ConstPtr<GEOSGeometry>, findAllLocations: i32, locations: Ptr<GEOSGeometry[]>): i8;
     ...
     * @param g - The geometry to test
     * @returns A string with the reason, NULL on exception.
     ...
     * @param g - The geometry to test
     * @param flags - A value from the {@link GEOSValidFlags} enum
     ...
     * @returns 0 if no exception occurred.
     ...
     * @param g - the input geometry
     * @returns a linestring geometry, or NULL if an exception occurred.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @see geos::precision::MinimumClearance
     * @deprecated this function is not exported
     */
     ...
     * @param g1 (in) - Input geometry
     * @param g2 (in) - Input geometry
     * @returns A coordinate sequence with the two points, or NULL on exception.
     ...
     * [Hausdorff distance]{@link https://en.wikipedia.org/wiki/Hausdorff_distance}
     ...
     * @param g1 (in) - Input geometry
     * @param g2 (in) - Input geometry
     * @param densifyFrac (in) - The largest % of the overall line length that
    ...
    /**
     * Calculate the
     * [Frechet distance]{@link https://en.wikipedia.org/wiki/Fr%C3%A9chet_distance}
     ...
     * @returns The point {@link GEOSGeometry} that is distance from the start of line.
     ...
     * @returns The proportion of the overall line length that the projected
     * point falls at.
     * @deprecated this function is not exported
     */
     ...
     * @returns A newly allocated geometry of the intersection. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     ...
     * @returns A newly allocated geometry of the difference. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @see geos::operation::overlayng::OverlayNG
     */
     ...
     * @param ga - geometry A
     * @param gb - geometry B
     * @returns A newly allocated geometry of the symmetric difference. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @see geos::operation::overlayng::OverlayNG
     */
     ...
     * @param ga - geometry A
     * @param gb - geometry B
     * @returns A newly allocated geometry of the union. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @see geos::operation::overlayng::OverlayNG
     */
     ...
     * @param g - The input geometry
     * @returns A newly allocated geometry of the union, or NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
     ...
     * @returns The clipped geometry or NULL on exception
     * Caller is responsible for freeing with GEOSGeom_destroy().
     ...
     * @returns 1 if the operation was successful, 0 on exception
     * @deprecated this function is not exported
     */
    GEOSGridIntersectionFractions(g: ConstPtr<GEOSGeometry>, xmin: f64, ymin: f64, xmax: f64, ymax: f64, nx: u32, ny: u32, buf: Ptr<f32>): i32;
     ...
     * @deprecated this function is not exported
     */
    GEOSClusterDBSCAN(g: ConstPtr<GEOSGeometry>, eps: f64, minPoints: u32): Ptr<GEOSClusterInfo>;
     ...
     * @deprecated this function is not exported
     */
    GEOSClusterGeometryDistance(g: ConstPtr<GEOSGeometry>, d: f64): Ptr<GEOSClusterInfo>;
     ...
     * @deprecated this function is not exported
     */
    GEOSClusterGeometryIntersects(g: ConstPtr<GEOSGeometry>): Ptr<GEOSClusterInfo>;
     ...
     * @deprecated this function is not exported
     */
    GEOSClusterEnvelopeDistance(g: ConstPtr<GEOSGeometry>, d: f64): Ptr<GEOSClusterInfo>;
     ...
     * @deprecated this function is not exported
     */
    GEOSClusterEnvelopeIntersects(g: ConstPtr<GEOSGeometry>): Ptr<GEOSClusterInfo>;

    /**
     * Get the number of clusters identified by a clustering operation
     * @param clusters - cluster information object
     * @returns number of clusters identified
     * @deprecated this function is not exported
     */
    GEOSClusterInfo_getNumClusters(clusters: ConstPtr<GEOSClusterInfo>): u32;
     ...
     * @deprecated this function is not exported
     */
    GEOSClusterInfo_getClusterSize(clusters: ConstPtr<GEOSClusterInfo>, i: u32): u32;
     ...
     * @param clusters - cluster information object
     * @returns an array of cluster indices, to be freed by the caller.
     * @deprecated this function is not exported
     */
    GEOSClusterInfo_getClustersForInputs(clusters: ConstPtr<GEOSClusterInfo>): Ptr<u32>;

    /**
     * @param clusters - cluster information object
     * @param i - index of the cluster for which indices should be retrieved
     * @returns a pointer to an array of cluster indices. Size of the array is indicated by
     ...
     * @deprecated this function is not exported
     */
    GEOSClusterInfo_getInputsForClusterN(clusters: ConstPtr<GEOSClusterInfo>, i: u32): ConstPtr<u32>;
     ...
     * @deprecated this function is not exported
     */
    GEOSClusterInfo_destroy(clusters: Ptr<GEOSClusterInfo>): void;
     ...
     * @returns A {@link GEOSGeometry} of the buffered result.
     ...
     * of buffered generated by {@link GEOSBuffer}.
     * @returns A newly allocated GEOSBufferParams. NULL on exception.
     ...
     * which must be one enumerated in {@link GEOSBufCapStyles}.
     * @returns 0 on exception, 1 on success.
     */
     ...
     * which must be one enumerated in {@link GEOSBufJoinStyles}.
     * @returns 0 on exception, 1 on success.
     */
     ...
     * @returns The buffered geometry, or NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     */
     ...
     * @param quadsegs - Number of segments per quadrant
     * @param endCapStyle - See {@link GEOSBufCapStyles}
     * @param joinStyle - See {@link GEOSBufJoinStyles}
     ...
     * @param joinStyle - See {@link GEOSBufJoinStyles}
     * @param mitreLimit - See GEOSBufferParams_setMitreLimit
     * @returns The offset geometry. Returns NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     ...
     * guaranteed.
     * @param g - The input geometry
     * @returns A geometry that covers all the points of the input geometry.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
     ...
     * @returns A value of 1 for a valid coverage, 0 for invalid and 2 for
     ...
     * @returns A collection containing the simplified geometries, or null
     *         on error.
     * @deprecated this function is not exported
     */
     ...
     * the way invalid polygon interactions are repaird by {@link GEOSCoverageCleanWithParams}.
     * @returns A newly allocated GEOSCoverageCleanParams. NULL on exception.
     * Caller is responsible for freeing with GEOSCoverageCleanParams_destroy().
     * @deprecated this function is not exported
     */
    GEOSCoverageCleanParams_create(): Ptr<GEOSCoverageCleanParams>;
     ...
     * @deprecated this function is not exported
     */
    GEOSCoverageCleanParams_destroy(params: Ptr<GEOSCoverageCleanParams>): void;
     ...
     * @deprecated this function is not exported
     */
    GEOSCoverageCleanParams_setSnappingDistance(params: Ptr<GEOSCoverageCleanParams>, snappingDistance: f64): i32;
     ...
     * @deprecated this function is not exported
     */
    GEOSCoverageCleanParams_setGapMaximumWidth(params: Ptr<GEOSCoverageCleanParams>, gapMaximumWidth: f64): i32;

    /**
     * Sets the overlap merge strategy to use, using one from {@link GEOSOverlapMerge}.
     ...
     * @param params - The GEOSCoverageCleanParams to operate on
     * @param overlapMergeStrategy - One of {@link GEOSOverlapMerge} strategies
     * @returns 0 on exception, 1 on success.
     * @see geos::coverage::CoverageCleaner::setGapMaximumWidth
     * @deprecated this function is not exported
     */
    GEOSCoverageCleanParams_setOverlapMergeStrategy(params: Ptr<GEOSCoverageCleanParams>, overlapMergeStrategy: i32): i32;
     ...
     * @returns A collection containing the cleaned geometries, or null
     *         on error. Where cleaning has resulted in polygon collapse,
     *         an EMPTY geometry will be returned as part of the collection.
     * @deprecated this function is not exported
     */
    GEOSCoverageCleanWithParams(input: ConstPtr<GEOSGeometry>, params: ConstPtr<GEOSCoverageCleanParams>): Ptr<GEOSGeometry>;

    /**
     * @see GEOSCoverageCleanWithParams
     * @deprecated this function is not exported
     */
    GEOSCoverageClean(input: ConstPtr<GEOSGeometry>): Ptr<GEOSGeometry>;
     ...
     * @returns A newly allocated polygonal envelope or point. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
     ...
     * @param g - The input geometry
     * @returns A newly allocated geometry of the boundary. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
     ...
     * @param g - The input geometry
     * @returns A newly allocated geometry of the convex hull. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @see geos::operation::overlayng::OverlayNG
     * @deprecated this function is not exported
     */
     ...
     * mode, which is one defined in {@link GEOSPolygonHullParameterModes}.
     ...
     * @param g - the polygonal geometry to process
     * @param isOuter - indicates whether to compute an outer or inner hull (1 for outer hull, 0 for inner)
     * @param parameterMode - the interpretation to apply to the parameter argument; see {@link GEOSPolygonHullParameterModes}
     ...
     * @param g - The input geometry
     * @returns A newly allocated geometry of the rotated envelope. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
     ...
     * @returns A newly allocated geometry of the MIC. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     ...
     * @param tolerance - Stop the algorithm when the search area is smaller than this tolerance
     * @returns A newly allocated geometry of the LEC radius line. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     ...
     * @param g - The input geometry
     * @returns A newly allocated geometry of the LEC. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     ...
     * @param g - The input geometry
     * @returns A point that is inside the input
     * Caller is responsible for freeing with GEOSGeom_destroy().
     ...
     * @returns The circle geometry or NULL on exception
     * Caller is responsible for freeing with GEOSGeom_destroy().
     ...
     * @param flags - A value from the {@link GEOSVoronoiFlags} enum
     ...
     * @param g - The input geometry
     * @returns The noded geometry or NULL on exception
     * Caller is responsible for freeing with GEOSGeom_destroy().
     ...
     * @returns The polygonal output geometry.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     ...
     * @returns The polygonal valid output
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @see geos::operation::polygonize::Polygonizer
     * @deprecated this function is not exported
     */
     ...
     * @returns The densified geometry, or NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
    ...
    /**
     * Apply the
     * [Douglas/Peucker algorithm]{@link https://en.wikipedia.org/wiki/Ramer–Douglas–Peucker_algorithm}
    ...
    /**
     * Calculate the
     * [Hilbert code]{@link https://en.wikipedia.org/wiki/Hilbert_curve}
     ...
     * @param g (in) - Input geometry
     * @param callback (in) - a function to be executed for each coordinate in the
     ...
     * @returns a copy of the input geometry with transformed coordinates.
     * Caller must free with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
     ...
     * @deprecated this function is not exported
     */
    GEOSGeom_transformXYZ(g: ConstPtr<GEOSGeometry>, callback: Ptr<GEOSTransformXYZCallback>, userdata: Ptr<void>): Ptr<GEOSGeometry>;
     ...
     * @returns The snapped version of the input. NULL on exception.
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * @deprecated this function is not exported
     */
     ...
     * functions. The output will be a valid {@link GEOSGeometry}.
     *
     ...
     * @param flags - The bitwise OR of members of the {@link GEOSPrecisionRules} enum
     * @returns The precision reduced result.
     *         Caller must free with GEOSGeom_destroy()
     *         NULL on exception.
     * @deprecated this function is not exported
     */
    ...
    /**
     * Calculate the [DE9IM]{@link https://en.wikipedia.org/wiki/DE-9IM} string for a geometry pair
    ...
    /**
     * Calculate the [DE9IM]{@link https://en.wikipedia.org/wiki/DE-9IM} string for this geometry pair.
     * The result is a 9-character string containing dimension symbols in the set "012F".
     * @param g1 - First geometry in pair
     * @param g2 - Second geometry in pair
     * @returns DE9IM string. Caller is responsible for freeing with GEOSFree().
     *         NULL on exception
     * @see geos::geom::Geometry::relate
     */
    ...
    /**
     * Compare a [DE9IM]{@link https://en.wikipedia.org/wiki/DE-9IM} string to a pattern and return true if they
     * are consistent.
    ...
    /**
     * Calculate the [DE9IM]{@link https://en.wikipedia.org/wiki/DE-9IM} string for this geometry pair,
     * using the supplied {@link GEOSRelateBoundaryNodeRules}.
     * @param g1 - First geometry in pair
     * @param g2 - Second geometry in pair
     * @param bnr - A member of the {@link GEOSRelateBoundaryNodeRules} enum
     * @returns DE9IM string. Caller is responsible for freeing with GEOSFree().
     *         NULL on exception
     * @see geos::geom::Geometry::relate
     ...
     * @returns A prepared geometry. Caller is responsible for freeing with
     *         GEOSPreparedGeom_destroy()
     */
    GEOSPrepare(g: ConstPtr<GEOSGeometry>): ConstPtr<GEOSPreparedGeometry>;

    /**
     * Free the memory associated with a {@link GEOSPreparedGeometry}.
     * Caller must separately free the base {@link GEOSGeometry} used
    ...
    /**
     * Use a {@link GEOSPreparedGeometry} do a high performance
    ...
    /**
     * Using a {@link GEOSPreparedGeometry} do a high performance
    ...
    /**
     * Use a {@link GEOSPreparedGeometry} do a high-performance
     * calculation of the [DE9IM]{@link https://en.wikipedia.org/wiki/DE-9IM} relationship between the
    ...
    /**
     * Create a new {@link GEOSSTRtree} using the Sort-Tile-Recursive algorithm
     * ([STRtree]{@link https://en.wikipedia.org/wiki/R-tree})
     ...
     * @param tree - the {@link GEOSSTRtree} to apply the build to
     * @returns 1 on success, 0 on error
     * @deprecated this function is not exported
     */
     ...
     * @param tree - the {@link GEOSSTRtree} in which the item should be inserted
    ...
    /**
     * Query a {@link GEOSSTRtree} for items intersecting a specified envelope.
     * The tree will automatically be constructed if necessary, after which
     * no more items may be added.
     * @param tree - the {@link GEOSSTRtree} to search
    ...
    /**
     * Returns the nearest item in the {@link GEOSSTRtree} to the supplied geometry.
     * All items in the tree MUST be of type {@link GEOSGeometry}.
     ...
     * @returns a const pointer to the nearest {@link GEOSGeometry} in the tree to 'geom', or NULL in
     *            case of exception
     * @deprecated this function is not exported
     */
    ...
    /**
     * Returns the nearest item in the {@link GEOSSTRtree} to the supplied item
     * The tree will automatically be constructed if necessary, after which
     * no more items may be added.
     ...
     * @returns a const pointer to the nearest item in the tree to `item`, or NULL in
     *            case of exception
     * @deprecated this function is not exported
     */
    ...
    /**
     * Iterate over all items in the {@link GEOSSTRtree}.
    ...
    /**
     * Frees all the memory associated with a {@link GEOSSTRtree}.
     ...
     * @param tree - the {@link GEOSSTRtree} to destroy
     * @deprecated this function is not exported
     */
     ...
     * @returns -1 if reaching P takes a counter-clockwise (left) turn,
     ...
     * @returns A {@link GEOSGeometry}, caller to free with GEOSGeom_destroy())
     */
     ...
     * @param writer - A {@link GEOSWKTWriter}.
     * @param g - Input geometry
     * @returns A newly allocated string containing the WKT output or NULL on exception.
     * Caller must free with GEOSFree()
     */
    GEOSWKTWriter_write(writer: Ptr<GEOSWKTWriter>, g: ConstPtr<GEOSGeometry>): Ptr<string>;

    /**
     * Sets the number trimming option on a {@link GEOSWKTWriter}.
     ...
     * positional notation is used; see {@link GEOS_printDouble} for details.
     ...
     * @param reader - A {@link GEOSWKBReader}
     * @param wkb - A pointer to the buffer to read from
     * @param size - The number of bytes of data in the buffer
     * @returns A {@link GEOSGeometry} built from the WKB, or NULL on exception.
     */
     ...
     * @param size - The number of bytes of data in the buffer
     * @returns A {@link GEOSGeometry} built from the HEX WKB, or NULL on exception.
     * @deprecated this function is not exported
     */
     ...
     * @param writer - The {@link GEOSWKBWriter} controlling the
     * writing.
     ...
     * [byte order]{@link https://en.wikipedia.org/wiki/Endianness}
     * that is big or little endian.
     * The return value is a member of {@link GEOSWKBByteOrders}.
     ...
     * a value from {@link GEOSWKBByteOrders} enum.
     ...
     * [WKB]{@link https://en.wikipedia.org/wiki/Well-known_text_representation_of_geometry#Well-known_binary}
     ...
     * The return value is a member of {@link GEOSWKBFlavors}.
     ...
     * a value from {@link GEOSWKBFlavors} enum.
     ...
     * Set the output dimensionality of the writer. Either
     * 2 or 3 dimensions.
     * @param writer - A {@link GEOSGeoJSONWriter}.
     * @param dim - The dimensionality desired.
     * @deprecated this function is not exported
     */
    GEOSGeoJSONWriter_setOutputDimension(writer: Ptr<GEOSGeoJSONWriter>, dim: i32): void;

    /**
     * Reads the current output dimension from a {@link GEOSGeoJSONWriter}.
     * @param writer - A {@link GEOSGeoJSONWriter}.
     * @returns The current dimension.
     * @deprecated this function is not exported
     */
    GEOSGeoJSONWriter_getOutputDimension(writer: Ptr<GEOSGeoJSONWriter>): i32;
