...
import { lineString, multiPoint, multiPolygon, point, polygon } from '../../src/misc/helpers.mjs';
import { isValid, isValidOrThrow } from '../../src/predicates/is-valid.mjs';
...
describe('isValid and isValidOrThrow', () => {
    ...
    it('should return whether geometry is valid', () => {
        ...
        assert.doesNotThrow(() => isValidOrThrow(a, 1));
        assert.equal(isValid(a), false);
        assert.throws(() => isValidOrThrow(a), {
            name: 'TopologyValidationError',
