...
import { symmetricDifference } from '../../src/operation/symmetric-difference.mjs';
...
describe('symmetricDifference', () => {
    ...
    it('(prec) should return symmetric difference of two geometries', () => {
        const a = fromWKT('LINESTRING(50 100, 50 200)');
        const b = fromWKT('LINESTRING(50 50, 50 150)');
        assert.equal(toWKT(symmetricDifference(a, b, 15)), 'MULTILINESTRING ((45 150, 45 195), (45 45, 45 105))');
        assert.equal(toWKT(symmetricDifference(b, a, 15)), 'MULTILINESTRING ((45 45, 45 105), (45 150, 45 195))');
    });
