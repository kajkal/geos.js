...
import { difference } from '../../src/operation/difference.mjs';
...
describe('difference', () => {
    ...
    it('(prec) should return difference of two line strings', () => {
        ...
        assert.equal(toWKT(difference(a, b, 2)), 'MULTILINESTRING ((2 8, 4 8), (6 8, 10 8))');
        assert.equal(toWKT(difference(b, a, 2)), 'LINESTRING EMPTY');
    });
